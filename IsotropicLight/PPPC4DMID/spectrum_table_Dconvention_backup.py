...
Eprimary = np.logspace(np.log10(5.),3.,Ngrid) #Cirelli table only allows particle energy between 5GeV and 100TeV
logEprimary = np.log10(Eprimary)

T_BH = np.logspace(-9,2.,Ngrid)
energy = np.logspace(-9,3.,Ngrid) #energy of secondary particles
