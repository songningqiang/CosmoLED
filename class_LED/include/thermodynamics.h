...
/**
 * Functions and parameters for large extra dimensions.
 */


static double xi_scalar[] = {0.0018695,0.0167,0.0675,0.1868,0.4156,0.8021,1.4011};
static double xi_fermion[] = {0.001028,0.0146,0.0612,0.1666,0.3619,0.6836,1.1736};
static double xi_vector[] = {4.2272e-04,0.0115,0.0611,0.1864,0.4316,0.8469,1.4884};
static double xi_graviton[] = {9.655e-5,0.0097235,0.099484,0.4927,1.9042,6.8861,24.6844};
static double b_scalar[] = {0.3952,0.3334,0.2832,0.2806,0.2846,0.2932,0.3044};
static double b_fermion[] = {0.3370,0.2758,0.2933,0.2879,0.2895,0.2959,0.2739};
static double b_vector[] = {0.2760,0.2203,0.2638,0.2743,0.2583,0.2975,0.3105};
static double c_scalar[] = {1.186,1.236,1.291,1.296,1.292,1.282,1.27};
static double c_fermion[] = {1.221,1.297,1.279,1.286,1.284,1.276,1.303};
static double c_vector[] = {1.264,1.361,1.311,1.303,1.329,1.279,1.265};
//particle_dict has structure 'particle_name':[mass,spin,dof,sigmoid_factor]
//neutrino is the sum of all flavors, particle/antiparticle are separated except for wboson and piCh
static double particle_dict[17][4] = {/*'photon':*/ {0,1.0,2,0},
			   /*'neutrino':*/ {0,0.5,3,0},
...
#define gramtoGeV 5.62e23
#define hbar 6.582e-25 //GeV*s
...
enum energy_deposition_function {
  ...
  DarkAges_LED,  /**< f(z) functions computed in the DarkAges modules, including large extra dimensions */
...
double * reio_inter_xe; /**< discrete \f$ X_e(z)\f$ values */
  ...
  */
  ...
  int PBH_n; /**< number of large extra dimensions */
  double PBH_Mpl; /**< Bulk Planck scale */
