...
import os
import sys
from .common_LED import finalize, feff_finalize, sample_spectrum
from .common_LED import finalize_file
from .__init__ import transfer_functions, DarkAgesError, get_redshift, get_logEnergies, print_info, print_warning, channel_dict
from .model_LED import annihilating_model, decaying_model, evaporating_model, annihilating_halos_model, accreting_model
...
def evaporating_PBH( PBH_mass_ini, transfer_functions, n, Mpl, out_file, logEnergies=None, redshift=None, **DarkOptions):
	u"""Wrapper for the calculation of :math:`f_c (z)` for a evaporating primordial
	black hole (PBH) with a given initial mass :code:`PBH_mass_ini` and prionts
	the table of them for all five deposition channels
	...
	model_from_file = evaporating_model(PBH_mass_ini,logEnergies,redshift,n,Mpl, **DarkOptions)
